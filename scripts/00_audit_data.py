...
def main():
    ...
    p.add_argument("--han", type=Path, required=True)
    p.add_argument("--liu", type=Path, required=True)
    p.add_argument("--li", type=Path, required=True)
