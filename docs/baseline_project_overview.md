...
主数据来自刘占伟目录中的7个 `21UBE0022_苏E02625F-2025-05-*.csv`。原始106,162行，278个重复时间戳聚合后为105,884个唯一记录；按相邻记录间隔大于10 s划分46个运行片段，片段内重采样到1 s，得到211,630行。时间范围为2025-05-17 08:10:14至2025-05-27 09:55:30。绝不跨运行片段插值。与`G:`长期归档的四项控制关键信号已完成7/7逐时间戳核对；归档文件名比真实时间晚一天。
