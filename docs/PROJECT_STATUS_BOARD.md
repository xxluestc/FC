...
| 8 | 负载归一化与N+1容量审计 | 当前诊断与物理确认项 | 30 kW包络、36.756 kW事后下界、40 kW候选分开报告；补35/40 kW敏感性 |
| 9 | 论文证据与核心章节初稿 | 已完成首版 | 统一公式、主张矩阵、8张规范表、segment统计、核心章节初稿 |
...
| 负载容量口径 | 30 kW不是额定功率 | 最坏健康/策略下留出6.65%正功率步不截峰时超双堆容量；40 kW需外部确认 |
